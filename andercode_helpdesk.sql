...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-09-2021 a las 19:00:27
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_l_usuario_02` ()  BEGIN
...
(5, 'prueba', 'prueba', 'prueba@prueba.com', '123456', 2, '2021-09-26 10:49:41', NULL, NULL, 1),
(7, 'test', 'test', 'test@test.com', '123456', 1, '2021-09-26 10:55:57', NULL, NULL, 1);
